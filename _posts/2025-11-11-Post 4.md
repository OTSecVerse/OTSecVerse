---
title: "Post 04 | Waveshare RS232/485 Gateway: Cleartext Transmission of Admin Credentials (CVE-2025-63364)"
tags: [Waveshare, HTTP Security, Cleartext Credentials, Basic Auth Exposure,IoT Security, ICS Cybersecurity, Network Sniffing, Payatu Research,CVE-2025-63364]
categories: Advisory
---
[View_CSAF]({{ '/assets/CSAF/CSAF-CVE-2025-63364.json' | relative_url }})
...
**CVE ID:** [CVE-2025-63364](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2025-63364)
...
- Passwords are included in the `Authorization:` header encoded in Base64  
- Base64 is reversible, making credential recovery trivial  
